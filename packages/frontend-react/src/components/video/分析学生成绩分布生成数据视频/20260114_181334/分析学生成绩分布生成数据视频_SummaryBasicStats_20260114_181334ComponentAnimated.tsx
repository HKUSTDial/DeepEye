...
export const 分析学生成绩分布生成数据视频_SummaryBasicStatsComponent: React.FC<SceneProps> = ({ 
  sceneStartOffset = 0, 
  narrations = [],
  animations = [],
  title = "学生成绩统计概览" 
    ...
    >
      ...
      >
        {cards.map((card, index) => {
          ...
          const borderWidth = emphasis > 1 ? 3 : 2;
          const boxShadow = emphasis > 1 
          ...
          return (
            <div
              ...
              style={{
                ...
                border: `${borderWidth}px solid ${card.color}`,
                borderRadius: 12,
