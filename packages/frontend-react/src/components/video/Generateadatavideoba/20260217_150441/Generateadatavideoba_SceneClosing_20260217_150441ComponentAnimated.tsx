...
import { AbsoluteFill, useCurrentFrame, useVideoConfig, interpolate, Easing } from 'remotion'; // Added Remotion imports
...
export const Generateadatavideoba_SceneClosingComponent: React.FC<SceneProps> = ({
  sceneStartOffset = 0,
  narrations = [] // Ensure narrations is always an array to prevent errors
}) => {
  ...
  const titleProgress = interpolate(
    ...
    [0, 1],
    {
      ...
      extrapolateRight: 'clamp', // Keep visible after animation
  ...
  // Define original styles to merge with animations
  ...
  const originalSubtitleStyle: React.CSSProperties = {
    ...
    maxWidth: '70%',
    lineHeight: 1.6,
    // opacity: 0.9, // This will be overridden by subtitleOpacity animation
  };
