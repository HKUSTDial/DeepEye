...
export const 根据这个给我生成数据视频_SceneClosingComponent: React.FC<SceneProps> = ({ 
  sceneStartOffset = 0,
  narrations = []
}) => {
    ...
    >
      ...
      <div
        style={{
          ...
          maxWidth: '70%',
          lineHeight: 1.6,
          // Original opacity 0.9 is overridden by animation to ensure full fade-in to 1
      ...
      {currentNarration && (
        <div
          style={{
            position: 'absolute',
            bottom: 35, // Positioned above the 80px bottom padding
            left: 0,
            right: 0,
            display: 'flex',
            justifyContent: 'center',
