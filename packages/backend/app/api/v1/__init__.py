...
from . import sessions, chat, datasources, workflows, workflow_templates, workflow_files, workflow_nodes, knowledge_bases, report, video, test
...
router.include_router(test.router)          # /api/v1/test（测试预览等）
