...
export const Generateadatavideo_SceneOpeningComponent: React.FC<SceneProps> = ({
  sceneStartOffset = 0,
  narrations = []
}) => {
  ...
  return (
    ...
    >
      {/* Wrapper to adjust vertical position for narration space */}
      <div
        style={{
          transform: 'translateY(-40px)', // Shift content up by 40px to visually reserve 80px at the bottom
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          width: '100%', // Allow inner elements to use maxWidth
        }}
      >
        {/* Main Title - add opacity and transform */}
        <div
          style={{
