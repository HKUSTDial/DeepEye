  ...
  return (
    <AbsoluteFill
      style={{
        ...
        // Center content vertically within the available space,
        // accounting for the bottom narration area.
        justifyContent: 'center',
        alignItems: 'center',
        fontFamily: "'Inter', 'Helvetica', 'Arial', sans-serif",
        paddingLeft: '80px', // Horizontal padding
        paddingRight: '80px', // Horizontal padding
        paddingBottom: '80px', // Reserve bottom 80px for narration subtitles
      }}
    >
      {/* Main Title */}
      <div
