...
export const 生成一个视频_SceneOpeningComponent: React.FC<SceneProps> = ({ sceneStartOffset = 0 }) => {
  return (
    <AbsoluteFill
      style={{
        background: '#0f1419',
        ...
        paddingBottom: '80px', // Reserve bottom 80px for narration subtitles, effectively shifting content up
      }}
    >
      {/* Main Title */}
      <div
