...
export const 分析学生成绩分布生成数据视频_AnalysisScoreDistributionComponent: React.FC<SceneProps> = ({ 
  sceneStartOffset = 0, 
  narrations = [],
  animations = [],
  title = "成绩分布统计概览" 
          ...
          return (
            <div
              ...
              style={{
                ...
                border: `${isEmphasized ? 3 : 2}px solid ${card.color}`,
                borderRadius: 12,
                padding: '28px 20px',
                display: 'flex',
                flexDirection: 'column',
                ...
                boxShadow: isEmphasized ? `0 0 20px ${card.color}40` : 'none',
              }}
            >
              {/* Number */}
              <div
