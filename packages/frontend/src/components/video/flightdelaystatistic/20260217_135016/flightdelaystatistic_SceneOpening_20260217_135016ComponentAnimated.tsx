...
import { useCurrentFrame, useVideoConfig } from 'remotion'; // Import Remotion hooks
...
export const flightdelaystatistic_SceneOpeningComponent: React.FC<SceneProps> = ({ 
  sceneStartOffset = 0,
  narrations = []
}) => {
  ...
  const subtitleDelay = 0.5;   // Subtitle appears after 0.5s (after title starts)
