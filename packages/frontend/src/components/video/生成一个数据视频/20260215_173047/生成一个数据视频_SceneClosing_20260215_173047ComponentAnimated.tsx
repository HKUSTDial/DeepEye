...
export const 生成一个数据视频_SceneClosingComponent: React.FC<SceneProps> = ({
  sceneStartOffset = 0,
  narrations = []
}) => {
  ...
  return (
    <AbsoluteFill
      style={{
        background: '#0f1419', // Specified background color
        display: 'flex',
        flexDirection: 'column',
        justifyContent: 'center',
        alignItems: 'center',
        fontFamily: "'Inter', 'Helvetica', 'Arial', sans-serif",
        padding: '0 80px 80px 80px', // Reserve bottom 80px for subtitles
      }}
    >
      ...
      <div
        style={{
          ...
          color: '#ffffff', // Specified title color
          textAlign: 'center',
          marginBottom: 20,
          maxWidth: '80%',
          lineHeight: 1.2,
      ...
      <div
        style={{
          ...
          color: '#e0e0e0', // Specified secondary text color
          textAlign: 'center',
          maxWidth: '70%',
          lineHeight: 1.6,
          // Original opacity: 0.9, but overwritten by animation
