...
export const Generateadatavideo_SceneClosingComponent: React.FC<SceneProps> = ({ 
  sceneStartOffset = 0,
  narrations = []
}) => {
    ...
    >
      ...
      <div
        style={{
          ...
          transition: 'none', // Disable CSS transitions for animated properties
        }}
      >
        感谢观看
      </div>

      {/* Summary text (using the narration text as the summary) - with delayed animation */}
      <div
        style={{
          ...
          maxWidth: '70%',
          lineHeight: 1.6,
          // Original opacity: 0.9, now overridden by animation
